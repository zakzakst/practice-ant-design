    ...
    <div className={styles.module}>
      <div>
        <div className="flex items-center gap-2 mb-4">
          <button onClick={handlePrev} className="px-3 py-1 rounded bg-gray-200 hover:bg-gray-300">
            ◀ 前へ
          </button>
          {/* <button
          onClick={handleToday}
        ...
        >
          ...
          <button onClick={handleNext} className="px-3 py-1 rounded bg-gray-200 hover:bg-gray-300">
            次へ ▶
          </button>
        </div>
      </div>
