  ...
  return (
    <section>
      ...
      <DesignBox className="mt-4">
        <ScrollArea className="h-[200px] w-[350px] rounded-md border p-4" scrollHideDelay={400}>
          ...
          king was furious, but he couldn&apos;t seem to stop Jokester. And then, one day, the
          people of the kingdom discovered that the jokes left by Jokester were so funny that they
