...
const ItemTypes: ItemType[] = Array(20).fill(null).map((_, index) => ({
  id: `item-${index + 1}`,
  label: `項目${index + 1}`,
}))

const Contents: Content[] = Array(20).fill(null).map((_, index) => ({
  id: `content-${index + 1}`,
...
const Page = () => {
  ...
  return <div className="container mx-auto [&>div]:max-h-[480px]">
